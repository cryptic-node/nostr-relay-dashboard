...
•	Safe & polished UX:
o	No confirmation popups on delete (instant and clean).
o	Green/grey color scheme with emerald accents locked in.
o	Mobile-friendly responsive dark UI.
o	Zero panics on UTF-8 notes.
o	Status messages under buttons are exact and green.
...
3.	git checkout main (for v1.0.1 stable)
